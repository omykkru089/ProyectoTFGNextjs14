...
const LoginPage = () => {
  ...
  return (
    <div className="grid place-items-center bg-[url('/fondo-registro2.webp')] w-full h-screen bg-cover font-['montserrat',_sans-serif]">
      ...
      <div className="grid flex flex-col place-items-center bg-[#1800252f] w-[300px] h-[270px] [box-shadow:0px_0px_30px_black] rounded-[15px] backdrop-filter backdrop-blur-md">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col w-4/5 gap-[10px]">
        ...
        <button
          type="submit"
          className="text-[#fff] cursor-pointer border-[1px] border-[solid] border-[black] rounded-[4px] mt-[0.2em] py-[0.3em] bg-[black] [transition:0.2s] mt-[5px] hover:-translate-x-[0] hover:-translate-y-1 hover:bg-[#d690ff] hover:[box-shadow:0_0.25rem_#000] active:translate-x-[0] active:[box-shadow:none]"
        >
          Iniciar Sesión
        </button>
